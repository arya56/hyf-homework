...
function getReply(command) {
  ...
  let fields = command.split('is');
    ...
    if (command === 'Hello my name is Benjamin' && nameHolder==="") {
      ...
      let xx= nameHolder ? nameHolder :`You haven't introduced to me!`;
      return xx;
        }
    ...
    let today= new Date();
    let date = `${today.getDate()}. of ${monthNames[(today.getMonth())]} ${today.getFullYear()}`
    return date;
  }
   ...
   setTimeout(function(){console.log("Timer done")},4000);
